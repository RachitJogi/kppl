              ...
              <div className='col-xl-12'>
                <div className='project-details-left-content'>
                  ...
                  <div className='text rich-text'>
                    ...
                    {/* <p>{projectDetails.content[0].content[0].value}</p>
                    <p>{projectDetails.content[1].content[0].value}</p>
                    <p>{projectDetails.content[2].content[0].value}</p> */}
                  </div>
                </div>
              </div>
            </div>
