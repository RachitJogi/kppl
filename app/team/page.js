                    ...
                    <section className="team-one-section">
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-xl-3 col-lg-3 col-md-6">
                                    {/*Team One Single*/}
                                    <div className="team-one-single wow fadeInLeft" data-wow-delay="500ms">
                                        <div className="team-one-img">
                                ...
                                <div className="col-xl-3 col-lg-3 col-md-6">
                                    {/*Team One Single*/}
                                    <div className="team-one-single wow fadeInLeft" data-wow-delay="600ms">
                                        <div className="team-one-img">
                                ...
                                <div className="col-xl-3 col-lg-3 col-md-6">
                                    {/*Team One Single*/}
                                    <div className="team-one-single wow fadeInLeft" data-wow-delay="700ms">
                                        <div className="team-one-img">
                                ...
                                <div className="col-xl-3 col-lg-3 col-md-6">
                                    {/*Team One Single*/}
                                    <div className="team-one-single wow fadeInLeft" data-wow-delay="800ms">
                                        <div className="team-one-img">
